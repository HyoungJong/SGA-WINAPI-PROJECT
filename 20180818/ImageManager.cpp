...
Image * ImageManager::addFrameImage(string strKey, const TCHAR * fileName, int width, int height, int frameX, int frameY, bool trans, COLORREF transColor = RGB(255,0,255))
{
	Image* img = findImage(strKey);
	if (img)
		return img;
