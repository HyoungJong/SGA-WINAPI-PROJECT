...
{
private:
	typedef std::map<string, Image*>			mapImageList;
	typedef std::map<string, Image*>::iterator	mapImageIter;
...
public:
	...
	void   render(string strKey, HDC hdc, int destX, int destY, int currentFrameX, int currentFrameY);
	void   render(string strKey, HDC hdc, int destX, int destY, int sourX, int sourY, int sourWidth, int sourHeight);	

	void   frameRender(string strKey, HDC hdc, int destX, int destY);
	void   frameRender(string strKey, HDC hdc, int destX, int destY, int currnetFrameX, int currentFrameY);
